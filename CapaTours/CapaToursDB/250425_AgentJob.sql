...
/****** Object:  Job [ActualizarToursExpirados]    Script Date: 25-Apr-25 19:35:45 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 25-Apr-25 19:35:45 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'ActualizarToursExpirados', 
		...
		@owner_login_name=N'DESKTOP-IKHVF0B\dvega', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [ActualizarToursExpiradosStep]    Script Date: 25-Apr-25 19:35:45 ******/
...
WHERE T.FechaFin IS NULL AND T.Estado = 0;', 
		@database_name=N'CapaToursBD', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
